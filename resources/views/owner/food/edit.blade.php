                                ...
                                <form method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="currency" name="currency">
                                                        <option value="KHR"
                                                            {{ old('currency', $getRecord->currency) === 'KHR' ? 'selected' : '' }}>
                                                            KHR</option>
                                                        <option value="USD"
                                                            {{ old('currency', $getRecord->currency) === 'USD' ? 'selected' : '' }}>
                                                            USD</option>
                                                    </select>
                                                </div>
                                            </div>
                                          ...
                                          <select class="form-control" name="category_id" required>
                                              ...
                                              @foreach ($categories as $category)
                                                  <option value="{{ $category->id }}"
                                                      {{-- Check if the category's ID matches the category_id of the current food record --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ old('description', $getRecord->description) }}" name="description"
